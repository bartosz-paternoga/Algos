...
agent1 = pg.load_policy_agent(h5py.File('/home/bart/updated_agent.h5'), board_size)
agent2 = pg.load_policy_agent(h5py.File('/home/bart/updated_agent.h5'), board_size)
