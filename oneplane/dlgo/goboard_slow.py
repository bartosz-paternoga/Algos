...
class GoString():  # <1>
    ...
    def merged_with(self, go_string):  # <2>
        ...
        # print("go_string.stones",go_string.stones)
...
# <2> 2 Returns the entire string of stones at a point: a GoString if a stone is
...
# end::is_over[]
    ...
    def winner(self):
        ...
        return game_result.winner, game_result.winning_margin